...
/**
 * Direct HTTP Bridge Server
 *
 * Direct HTTP access to Chrome extension without MCP layer.
 * This is for external tools that want direct browser control.
 *
 * Features:
 * - WebSocket server for Chrome extension connection
 * - HTTP endpoints for direct browser control (navigate, click, type, etc.)
 * - Console log and error aggregation
 * - Screenshot capture with local file saving
 * - Page content retrieval
 *
 * Runs on port 3026 (dedicated direct access port)
 */
...
// Configuration
const PORT = 3026; // Use port 3026 to avoid conflict with MCP server
...
console.log(
  "⚡ NOT CONNECTING? Close Chrome window (all tabs), re-open with Browser Tools activated\n",
);
