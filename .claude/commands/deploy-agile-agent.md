...
${enforceScope ? `
### 1. EXAMINE BEFORE CREATE:
- REQUIRED: Search codebase for existing functionality FIRST
- FORBIDDEN: Creating new when existing solutions available
- VALIDATE: Use existing patterns, extend don't duplicate

### 2. CREATIVITY CHANNELING:
- CHANNEL: Natural enthusiasm → Completion Report "Further Ideas" section
- FORBIDDEN: Scope expansion during implementation
- REQUIRED: Professional focus during execution

### 3. SCOPE CONFORMITY:
- FORBIDDEN: Framework changes (Agent B complete)
- FORBIDDEN: Other agent work, UI redesign
